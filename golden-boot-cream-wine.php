        ...
        <section id="container">
            <div class="miga">
                <ul>
                    ...
                    <li>
                        <a href="#"> Golden Boot Cream Wine</a>
                    </li>
                </ul>
            </div>
            <div id="content" class="section_wine cuerpo_b">
                ...
                <article class="product_single">
                    ...
                    <div class="cuerpo_e legend">
                        ...
                        <p class="P15 PBot">
                            The ideal service temperature is 13° C. It also can be consumed as appetizer or as a cocktail served with ice and an orange slice.It is also a perfect dessert wine, ideal with fruit (melon, orange) or ice creams.
                        </p>
                        <p class="P15 PBot">
